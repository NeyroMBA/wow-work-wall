...
const RAW: Raw[] = [
  ...
  },
  {
    ...
    features: ["Анализ что-если", "Переключатель", "Claude"],
    tools: ["Claude"],
  ...
  },
  {
    ...
    features: ["Переключатель", "Расчёт показателей", "Claude"],
    tools: ["Claude"],
  ...
  },
  {
    ...
    features: ["Нестандартный визуал", "Сториборд", "Claude"],
    tools: ["Claude"],
  ...
  },
  {
    ...
    author: "Анастасия Бачило",
    categories: ["Marketing"],
    features: ["Нестандартный визуал", "Claude"],
    tools: ["Claude"],
...
const COHORT_6: Raw[] = [
  {
    ...
    author: "Константин Симонов и Андрей Токарев",
    categories: ["Finance"],
    features: ["Динамика с 2019", "Просрочка и ставка", "Экспорт в PDF", "Ключевые выводы"],
    tools: ["Claude"],
...

  {
    ...
    categories: ["Logistics", "Finance"],
    features: ["Прогноз задержки", "Анализ что-если", "Экспорт в PDF"],
    tools: ["Claude"],
  ...
  },
  {
    ...
    features: ["ABC-анализ SKU", "Анализ что-если", "Автотесты"],
    tools: ["Claude"],
  ...
  },
  {
    ...
    features: ["Анимированная карта", "Подбор курорта", "Экспорт в PDF"],
    tools: ["Claude"],
  ...
  },
  {
    ...
    categories: ["Marketing", "Sales"],
    features: ["Кросс-фильтрация", "Сценарии", "Экспорт в PDF"],
    tools: ["Claude"],
  ...
  },
  {
    ...
    features: ["Анализ что-если", "Прогноз на карте", "Claude"],
    tools: ["Claude"],
  ...
  },
  {
    ...
    categories: ["Sales"],
    features: ["Воронка по менеджеру", "Фокус-режим", "Экспорт в PDF"],
    tools: ["Claude"],
