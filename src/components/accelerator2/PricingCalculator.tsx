  ...
  return (
    <section className="container mx-auto px-6 pb-16 md:pb-24">
      <div className="max-w-2xl mx-auto rounded-2xl border border-border bg-card p-6 md:p-8">
        <h3 className="text-center font-bold text-foreground text-[clamp(10px,3.2vw,24px)] leading-tight mb-6 md:mb-8 whitespace-nowrap">
        ...
        <div className="rounded-2xl border border-border bg-background divide-y divide-border">
          ...
          <div className="flex items-center justify-between gap-4 px-4 md:px-5 py-2 min-h-12">
            ...
            <input
              ...
              maxLength={7}
              className="w-[110px] md:w-[130px] rounded-lg border border-border bg-background px-3 py-1.5 text-right text-[16px] md:text-[18px] font-semibold text-foreground outline-none focus:border-primary transition-colors"
            />
          </div>
          ...
          <div className="flex items-center justify-between gap-4 px-4 md:px-5 py-2 min-h-12">
            ...
            <select
              ...
              className="rounded-lg border border-border bg-background px-3 py-1.5 text-[16px] md:text-[18px] font-semibold text-foreground outline-none focus:border-primary transition-colors cursor-pointer"
            >
