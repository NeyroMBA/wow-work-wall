...
import type { CourseDetail } from "@/data/accelerator2/courseDetails";
...
const CourseDialog = ({ open, onOpenChange, name, detail }: Props) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent data-theme="accelerator" className="max-w-2xl w-[calc(100vw-2rem)] max-h-[90vh] overflow-y-auto p-0 bg-background text-foreground border-border">
